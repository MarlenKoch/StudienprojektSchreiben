...
\newcommand{\topic}{Vereinfachung von Entwicklungsprozessen durch Large Language Models}
...
Es wird in der Regel das generische Maskulinum verwendet, wobei alle Geschlechter gleichermaßen adressiert werden
\clearpage

...
\glslink{glos:ki}{KI}-Modell halluzinieren können. Damit soll, ähnlich wie in der in \autoref{ch:anforderungen} behandelten Studie, die Akzeptanz von \glslink{glos:ki}{KI}-generierten Missinformationen verringert werden. Dadurch 
...
\auroref{sec:vorteile} beschriebenen Vorteile mit sich bringt. Der Schüler kann aus den bereits vorgefertigten Aufgaben für die \glslink{glos:ki}{KI} wählen, jedoch keinen eigenen Prompt verwenden. Dadurch soll 

...
\section{Motivation}
%TODO: ich finde solche leeren abschnitte immer nich so schön ist aber wirklich nur mein persöhnliches empfinden
...
%TODO: Das hier sind für mich Anforderungen
...
Der Schreibassistent wird für unterschiedliche Anwendungsfälle entwickelt: \\
 ...
 %TODO: das sowas generiert wird taucht hier das erste Mal auf und ist ein bisschen überraschend. Habe ich was überlesen?
...
%TODO: Das hier sind für mich auch Anforderungen
...
des Codes erhöht. React TypeScript bietet zusätzlich Typisierung, wodurch der Code weniger fehleranfällig ist. React wurde primär wegen seiner Performanz und Dynamik gewählt. \cite{react1,react2} \\
...
%TODO: dasd wort Wiederverwendbarkeit sollte hier nicht mehrfach wiederverwendet ;-) werden. nehmt ein Synonym und formuliert um
...
Python als Programmiersprache steigert ebenfalls die Effizienz, da sie einfach aufgebaut und weit verbreitet ist. Zudem existieren zahlreiche \mbox{zusätzliche Bibliotheken. \cite{python}}\\
...
Prüfungen der Antworten auf Ausdruck, Grammatik und Inhalt. Im Folgenden werden die wichtigsten \mbox{Testergebnisse beleuchtet:}
...
%TODO: Warum listet ihr das dann hier?
...
%TODO: Diese Test methode müsst ihr später auf jeden Fall kritisch hinterfrage! (ich habe noch nicht weitergelessen, wenn das also kommt ignoriert das hier)

[neue modelle ziehen]
%TODO: das soll glaube ich nicht mehr da sein
...
%TODO:: Diese details hier kommen ein bisschen aus dem nichts. soll das einfach nur ein beispiel sein? wenn ja, dann bitte kennzeichen weil sonst list man und list man und fragt sich was diese ganzen informatioen eigentlich sollen
...
%TODO: Das "Answers" kommt ein bisschen plötzlich heir weil ihr gefḧlt sonst immer viel wert auf die deutschen übersetzungen gelegt habt.

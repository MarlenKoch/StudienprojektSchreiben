...
\glslink{glos:ki}{KI}-Modell halluzinieren können. Damit soll, ähnlich wie in der in Kapitel xxx (4) behandelten Studie, die Akzeptanz von \glslink{glos:ki}{KI}-generierten Misinformationen verringert werden. Dadurch 

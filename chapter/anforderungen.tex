...
Einsatz von \glslink{glos:ki}{KI}  bei wissenschaftlichen Schreibaufgaben beeinflussen. Einige der identifizierten Kriterien, welche für die Implementierung des \glslink{glos:ki}{KI}-basierten Schreibassistenten relevant sind, werden nun \mbox{näher beleuchtet.} \\ 
...
KI beeinflusst wird.\\  
Eines der in \autoref{ch:technischeHintergründe} beschriebenen Risiken der Nutzung von \glslink{glos:ki}{KI} sind \glslink{halluzinationen}{Halluzinationen}, also generierte Fehlinformationen. In einem Artikel von Yoori Hwang und Se-Hoon Jeong wird untersucht, 

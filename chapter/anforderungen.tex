...
Kapitel 3.2.2 beschriebenen häufigen Einsatzmöglichkeiten sollten von einem \glslink{glos:ki}{KI}-Werkzeug unterstützt werden. Nach Cui sehen Studenten eine \glslink{glos:ki}{KI}-Applikation vor allem dann 
...
KI beeinflusst wird.\\  
Eines der im Kapitel 2 beschriebenen Risiken der Nutzung von \glslink{glos:ki}{KI} sind Halluzinationen, also generierte Fehlinformationen. Im Artikel "`Generative Artificial Intelligence 

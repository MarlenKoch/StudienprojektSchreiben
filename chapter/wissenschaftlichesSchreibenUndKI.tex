...
Weitere Verwendungsmöglichkeiten sind das Umformulieren von Texten, das Zusammenfassen von Literatur, das Formulieren von Texten aus Stichpunkten und die Verbesserung des Stils und der Grammatik von bereits geschriebenen Texten. Die genannten Einsatzmöglichkeiten 
...
Überdies ergibt sich durch die in \autoref{sec:llm} beschriebene Funktionsweise von \glslink{glos:ki}{KI} eine Plagiatsgefahr. \glslink{glos:ki}{KI}-Werkzeuge wie ChatGPT generieren einen Text Wort für Wort, wobei das nächste anhand 
...
So gibt es zum Beispiel zahlreiche Online-\glslink{glos:ki}{KI}-Chats, angefangen bei den openAI-Modellen wie ChatGPT. Werden diese zum Verfassen wissenschaftlicher Texte zur Hilfe genommen, ergeben 
...
Es gibt also bereits einige, teilweise auch auf den Schreibprozess spezialisierte, \glslink{glos:ki}{KI}-Lösungen. Jedoch verfügt keines der beschriebenen Hilfsmittel über den vollen in \autoref{sec:vorteile}

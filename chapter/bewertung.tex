...
Das Ergebnis dieses Projektes ist ein Schreibassistent, welcher eine Nutzeroberfläche für \glslink{ollama}{Ollama} bietet. Damit muss für die Handhabung lokaler \glslink{glos:ki}{KI}-Modelle kein Terminal genutzt werden. 
%TODO: der vergleich mit kein Terminal nutzen finde ich hier schlecht, weil das nicht der selling point von euch ist. Es gibt zich andere wrapper um Ollama die schönnere, bessere und schelere UIs habe. Euer selling point sind die kontroller von der KI nutzung und anleitung des nutzers, Das würde ich heir als wichtigstes argument als erstes neennen
...
%TODO: gefällt mir gut der absatz, ich würde noch ein bisschen klarer strukturieren, aber ansonst gut

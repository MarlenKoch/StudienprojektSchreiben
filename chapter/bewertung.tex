...
Um dieses Problem zu lösen, sollte in Zukunft auch das Einbinden externer \glslink{glos:ki}{KI}-Modelle ermöglicht werden. Um dennoch den Datenschutz zu gewährleisten, könnte man ein weiteres \glslink{glos:llm}{LLM}

...
der folgenden Schicht weitergegeben wird. Die Gewichtungen der Verbindungen zwischen zwei Schichten können als Matrix dargestellt werden, dementsprechend entspricht der Übergang von einer 
Schicht zu der darauf folgenden einer Matrixmultiplikation. \\
...
Moderne LLMs wie ChatGPT basieren auf einer Transformer-Architektur. [welche auf einer Transformerarchitektur basiert] Diese berechnet aus einem Eingabetext eine Wahrscheinlichkeitsverteilung 
